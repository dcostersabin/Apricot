from codeAnalyzer.GitClone.GithHubClone import RepoClone
import os
import subprocess
...
class RubyChecker:
    ...
    def __init__(self, url, username, access_token, repo_name):
        ...
        self.url = url
        self.repo = RepoClone(url=self.url, username=username, access_token=access_token, repo_name=repo_name)
